...
export class TradingSystemEditPanel extends AbstractPanel {
  ...
  @ViewChild("tsFeedCtrl")      tsFeedCtrl?      : SelectTextRequired
  ...
  constructor(eventBusService          : EventBusService,
    ...
    inventoryService.getProductFeeds(false).subscribe(
      result => {
        this.feeds = result.result;
      })
